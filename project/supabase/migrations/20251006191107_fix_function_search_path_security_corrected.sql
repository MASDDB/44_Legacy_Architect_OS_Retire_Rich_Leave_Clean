...
-- This migration addresses the jsonb_build_object error and other built-in function calls
-- When search_path is set to empty, built-in PostgreSQL functions should not have public. prefix

-- Drop and recreate functions with secure search_path and correct function calls
...
BEGIN
    ...
    -- Build analytics JSON - use built-in jsonb_build_object without public prefix
